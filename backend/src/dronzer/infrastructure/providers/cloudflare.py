...
class CloudflareProvider(IProvider):
    ...
    def __init__(self, default_base_url: str = "https://api.cloudflare.com/client/v4/accounts/{account_id}/ai/v1"):
    ...
    def _resolve_url(self, base_url: str | None, endpoint: str) -> str:
        ...
        if "{account_id}" in url:
            ...
            logger.warning("Cloudflare account_id in base URL was not resolved. Ensure the base URL is set in the database.")
