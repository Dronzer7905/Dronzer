...
logger = structlog.get_logger("dronzer.providers.cerebras")

class CerebrasProvider(IProvider):
    """
    Cerebras API integration (OpenAI compatible).
    """

    def __init__(self, default_base_url: str = "https://api.cerebras.ai/v1"):
