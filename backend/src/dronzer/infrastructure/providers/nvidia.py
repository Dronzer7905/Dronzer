...
logger = structlog.get_logger("dronzer.providers.nvidia")

class NvidiaNIMProvider(IProvider):
    """
    NVIDIA NIM integration (OpenAI compatible).
    """

    def __init__(self, default_base_url: str = "https://integrate.api.nvidia.com/v1"):
