...
logger = structlog.get_logger("dronzer.providers.vllm")

class VLLMProvider(IProvider):
    """
    vLLM High-throughput cluster API integration (OpenAI compatible).
    """

    def __init__(self, default_base_url: str = "http://localhost:8000/v1"):
