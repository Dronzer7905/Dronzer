...
class ProtocolAdapter:
    ...
    async def translate_rest_to_event(self, request_method: str, path: str, payload: dict[str, Any]) -> dict[str, Any]:
        """
    ...
    async def translate_graphql_to_event(self, query: str, variables: dict[str, Any]) -> dict[str, Any]:
        """
