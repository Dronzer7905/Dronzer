...
class ApprovalWorkflowEngine:
    ...
    async def create_request(self, org_id: str, requester_id: str, action: str, payload: dict[str, Any], roles_required: list[str]) -> str:
    ...
    async def review_request(self, request_id: str, reviewer_id: str, approved: bool) -> bool:
        ...
        logger.info("Approval Request Reviewed", request_id=request_id, status=status.value, reviewer=reviewer_id)
